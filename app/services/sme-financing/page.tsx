  ...
  const offeringsData = [
    {
      ...
      description:
        'Financing to help you execute supply contracts and government orders without depleting your working capital. Take advantage of business opportunities when they arise.',
    ...
    },
    {
      ...
      description:
        "Unlock cash tied up in unpaid invoices to maintain steady cash flow and keep operations running smoothly. Get paid today for the work you've already delivered.",
    ...
    },
    {
      ...
      description:
        "Short-term funding to bridge the gap between project execution and final payment. Ensure your projects don't stall due to temporary funding constraints.",
    ...
    },
    {
      ...
      description:
        'Structured long-term financing for larger scale business expansion and capital intensive projects. Built for ambitious enterprises planning significant steps.',
