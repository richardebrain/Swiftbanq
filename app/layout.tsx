...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Swiftbanq Credit Solutions | Digital Lending & Financing in Nigeria',
    template: '%s | Swiftbanq Credit Solutions',
  },
  description: 'Swiftbanq Credit Solutions is a licensed NBFI in Lagos, Nigeria offering SME financing, asset financing, digital lending, and treasury services. Apply online today.',
  keywords: [
    'Swiftbanq',
